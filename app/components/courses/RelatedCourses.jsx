          ...
          >
            <div className="relative">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                <span className="text-white font-medium">{relatedCourse.title}</span>
              </div>
            </div>
            <div className="p-4">
              ...
              <div className="flex justify-between items-center">
                <span className="font-bold text-purple-600">${relatedCourse.price.toFixed(2)}</span>
                <span className="text-sm text-gray-600">{relatedCourse.duration}</span>
              </div>
            </div>
          </Link>
        ))}
